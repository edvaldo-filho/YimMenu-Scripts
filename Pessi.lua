...
function TransactionManager.new()
    ...
    instance.Transactions = {
        {label = "15M (Bend Job Limited) - JUST 1 CLICK !", hash = 0x176D9D54},
        {label = "15M (Bend Bonus Limited) - JUST 1 CLICK !", hash = 0xA174F633},
        {label = "7M (Gang Money Limited) - JUST 1 CLICK !", hash = 0xED97AFC1},
        {label = "3.6M (Casino Heist Money Limited) - JUST 1 CLICK !", hash = 0xB703ED29},
        {label = "2.5M (Gang Money Limited) - JUST 1 CLICK !", hash = 0x46521174},
        {label = "2.5M (Island Heist Money Limited) - JUST 1 CLICK !", hash = 0xDBF39508},
        {label = "2M (Heist Awards Money Limited) - JUST 1 CLICK !", hash = 0x8107BB89},
        {label = "2M (Tuner Robbery Money Limited) - JUST 1 CLICK !", hash = 0x921FCF3C},
        {label = "2M (Business Hub Money Limited) - JUST 1 CLICK !", hash = 0x4B6A869C},
        {label = "1M (Avenger Operations Money Limited) - JUST 1 CLICK !", hash = 0xE9BBC247},
        {label = "1M (Daily Objective Event Money Limited) - JUST 1 CLICK !", hash = 0x314FB8B0},
        {label = "1M (Daily Objective Money Limited) - JUST 1 CLICK !", hash = 0xBFCBE6B6},
        {label = "680K (Betting Money Limited) - JUST 1 CLICK !", hash = 0xACA75AAE},
        {label = "500K (Juggalo Story Money Limited) - JUST 1 CLICK !", hash = 0x05F2B7EE},
        {label = "310K (Vehicle Export Money Limited) - JUST 1 CLICK !", hash = 0xEE884170},
        {label = "200K (DoomsDay Finale Bonus Money Limited) - JUST 1 CLICK !", hash = 0xBA16F44B},
        {label = "200K (Action Figures Money Limited) - JUST 1 CLICK !",  hash = 0x9145F938},
        {label = "200K (Collectibles Money Limited) - JUST 1 CLICK !",    hash = 0xCDCF2380},
        {label = "190K (Vehicle Sales Money Limited) - JUST 1 CLICK !",   hash = 0xFD389995}
    }
...
function TransactionManager:Init()
    local tab               = gui.get_tab("Pessi SCRIPT")
    ...
    local sub_transactionL  = tab:add_tab("Limited Transactions - 1 Time click")
