...
wasabi_words = gui.get_tab("GUI_TAB_SELF"):add_tab("Unlock All") --WasabiWords™️
...
wasabi_words:add_button("Unlock All", function() --Original script by ShinyWasabi
    ...
    script.execute_as_script("shop_controller", function ()
        ...
        gui.show_message('Unlocker', 'Complete !')
    end)
    end)
end)

wasabi_words:add_text("Unlock All is 1 time click")

wasabi_words:add_separator()

wasabi_words:add_button("Unlock all daily rewards", function() --Original script by ShinyWasabi
    script.run_in_fiber(function (wasabiwords_script1)
...
wasabi_words:add_button("Unlock Weekly Objectives", function() --Original script by ShinyWasabi
    script.run_in_fiber(function (wasabiwords_script2)
